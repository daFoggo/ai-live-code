...
interface IOverallSectionProps {
    summary: ICodeEvaluation["summary"];
}
export const OverallSection = ({ summary }: IOverallSectionProps) => {
    const overallStatusConfig = getSummaryCriteriaStatusConfig(summary.status);
